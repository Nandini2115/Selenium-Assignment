...
public class Testcase1 {
	...
	public static void main(String[] args) throws IOException, InterruptedException, AWTException {
		...
		FileInputStream fis_p = new FileInputStream("./src/test/java/Day6_Assignment/Testcase1.properties");
		...
		FileInputStream fis_excel = new FileInputStream("./src/test/java/Day6_Assignment/Testcase1.xlsx");
...
//		driver.findElement(By.xpath("//div[@role='option']//span[normalize-space()='"+role+"']")).click();
		...
		employee1.sendKeys(EmployeeName);
		Thread.sleep(2000);
		driver.findElement(By.xpath("//div[@role='listbox']//span[normalize-space()='" + EmployeeName + "']")).click();
		Thread.sleep(1000);
