...
public class Testcase1 {
	public static void main(String[] args) throws IOException, InterruptedException, AWTException  {
		...
		FileInputStream fis = new FileInputStream("./src/test/java/Day8_Assignment/commondata.properties");
		...
		//excelfile
		FileInputStream fis1 = new FileInputStream("./src/test/java/Day8_Assignment/day8.xlsx");
		...
		//resume
		Thread.sleep(5000);
		p2.getResume("C:\\Users\\HP\\Downloads\\Karuturi_Nandini_8.pdf");
		p2.getSave();
